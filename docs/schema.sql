...
-- Last updated: 2026-04-13 (commission rates confirmed, referral links, client cap, reorder tracking)
...
CREATE TABLE trainers (
    ...
    niche TEXT,
    social_media TEXT,
    slug TEXT UNIQUE, -- persistent referral URL segment (e.g. /r/john-smith)
    tier trainer_tier NOT NULL DEFAULT 'trainer',
    status trainer_status NOT NULL DEFAULT 'applied',
    commission_rate DECIMAL NOT NULL DEFAULT 0.20, -- base rate: 20% on first sale
    reorder_commission_rate DECIMAL NOT NULL DEFAULT 0.10, -- recurring rate: 10% on reorders
    max_clients INT NOT NULL DEFAULT 100, -- cap per trainer, adjustable per tier
    wise_account TEXT,
...
CREATE TABLE commissions (
    ...
    commission_type commission_type NOT NULL, -- first_sale or reorder
    rate_snapshot DECIMAL NOT NULL, -- snapshotted from commission_rate or reorder_commission_rate
